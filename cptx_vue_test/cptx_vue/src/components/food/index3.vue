...
<script>
 import content7 from "./content7.vue"
...
.meishi-ul li:nth-child(2){color:red !important;}
...
.ul2 li:first-child{margin-left:4px}
...
.tupian{width:60%;margin:0 auto;margin-top:6px;}
